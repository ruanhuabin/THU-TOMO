...
void amoeba(Mat_IO_DP &p, Vec_IO_DP &y, const DP ftol, DP funk(Vec_I_DP &,vector<Track> &,float *,float *,float),
	int &nfunk,vector<Track> &tracks,float *d_x,float *d_y,float psi);
DP amotry(Mat_IO_DP &p, Vec_O_DP &y, Vec_IO_DP &psum, DP funk(Vec_I_DP &,vector<Track> &,float *,float *,float),
	const int ihi, const DP fac,vector<Track> &tracks,float *d_x,float *d_y,float psi);
...
DP golden(const DP ax, const DP bx, const DP cx, DP f(const DP,vector<Track> &,float *,float *,float,int,float*,float*),
